...
func RegisterConversions(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedConversionFuncs(
		...
		Convert_v1_ServiceAffinityConfig_To_api_ServiceAffinityConfig,
		Convert_api_ServiceAffinityConfig_To_v1_ServiceAffinityConfig,
		Convert_v1_ServiceAffinityConfigClientIP_To_api_ServiceAffinityConfigClientIP,
		Convert_api_ServiceAffinityConfigClientIP_To_v1_ServiceAffinityConfigClientIP,
...
func autoConvert_v1_ServiceAffinityConfig_To_api_ServiceAffinityConfig(in *v1.ServiceAffinityConfig, out *api.ServiceAffinityConfig, s conversion.Scope) error {
	out.ClientIPConfig = (*api.ServiceAffinityConfigClientIP)(unsafe.Pointer(in.ClientIPConfig))
	return nil
}

// Convert_v1_ServiceAffinityConfig_To_api_ServiceAffinityConfig is an autogenerated conversion function.
func Convert_v1_ServiceAffinityConfig_To_api_ServiceAffinityConfig(in *v1.ServiceAffinityConfig, out *api.ServiceAffinityConfig, s conversion.Scope) error {
	return autoConvert_v1_ServiceAffinityConfig_To_api_ServiceAffinityConfig(in, out, s)
}

func autoConvert_api_ServiceAffinityConfig_To_v1_ServiceAffinityConfig(in *api.ServiceAffinityConfig, out *v1.ServiceAffinityConfig, s conversion.Scope) error {
	out.ClientIPConfig = (*v1.ServiceAffinityConfigClientIP)(unsafe.Pointer(in.ClientIPConfig))
	return nil
}

// Convert_api_ServiceAffinityConfig_To_v1_ServiceAffinityConfig is an autogenerated conversion function.
func Convert_api_ServiceAffinityConfig_To_v1_ServiceAffinityConfig(in *api.ServiceAffinityConfig, out *v1.ServiceAffinityConfig, s conversion.Scope) error {
	return autoConvert_api_ServiceAffinityConfig_To_v1_ServiceAffinityConfig(in, out, s)
}

func autoConvert_v1_ServiceAffinityConfigClientIP_To_api_ServiceAffinityConfigClientIP(in *v1.ServiceAffinityConfigClientIP, out *api.ServiceAffinityConfigClientIP, s conversion.Scope) error {
	out.TimeoutSeconds = in.TimeoutSeconds
	return nil
}

// Convert_v1_ServiceAffinityConfigClientIP_To_api_ServiceAffinityConfigClientIP is an autogenerated conversion function.
func Convert_v1_ServiceAffinityConfigClientIP_To_api_ServiceAffinityConfigClientIP(in *v1.ServiceAffinityConfigClientIP, out *api.ServiceAffinityConfigClientIP, s conversion.Scope) error {
	return autoConvert_v1_ServiceAffinityConfigClientIP_To_api_ServiceAffinityConfigClientIP(in, out, s)
}

func autoConvert_api_ServiceAffinityConfigClientIP_To_v1_ServiceAffinityConfigClientIP(in *api.ServiceAffinityConfigClientIP, out *v1.ServiceAffinityConfigClientIP, s conversion.Scope) error {
	out.TimeoutSeconds = in.TimeoutSeconds
	return nil
}

// Convert_api_ServiceAffinityConfigClientIP_To_v1_ServiceAffinityConfigClientIP is an autogenerated conversion function.
func Convert_api_ServiceAffinityConfigClientIP_To_v1_ServiceAffinityConfigClientIP(in *api.ServiceAffinityConfigClientIP, out *v1.ServiceAffinityConfigClientIP, s conversion.Scope) error {
	return autoConvert_api_ServiceAffinityConfigClientIP_To_v1_ServiceAffinityConfigClientIP(in, out, s)
}
...
func autoConvert_v1_ServiceSpec_To_api_ServiceSpec(in *v1.ServiceSpec, out *api.ServiceSpec, s conversion.Scope) error {
	...
	out.ServiceAffinityConfig = (*api.ServiceAffinityConfig)(unsafe.Pointer(in.ServiceAffinityConfig))
	return nil
}
...
func autoConvert_api_ServiceSpec_To_v1_ServiceSpec(in *api.ServiceSpec, out *v1.ServiceSpec, s conversion.Scope) error {
	...
	out.ServiceAffinityConfig = (*v1.ServiceAffinityConfig)(unsafe.Pointer(in.ServiceAffinityConfig))
	out.LoadBalancerSourceRanges = *(*[]string)(unsafe.Pointer(&in.LoadBalancerSourceRanges))
