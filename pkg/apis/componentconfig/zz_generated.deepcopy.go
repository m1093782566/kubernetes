...
func RegisterDeepCopies(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedDeepCopyFuncs(
		...
		conversion.GeneratedDeepCopyFunc{Fn: DeepCopy_componentconfig_KubeProxyIPVSConfiguration, InType: reflect.TypeOf(&KubeProxyIPVSConfiguration{})},
...
// DeepCopy_componentconfig_KubeProxyIPVSConfiguration is an autogenerated deepcopy function.
func DeepCopy_componentconfig_KubeProxyIPVSConfiguration(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		in := in.(*KubeProxyIPVSConfiguration)
		out := out.(*KubeProxyIPVSConfiguration)
		*out = *in
		return nil
	}
}
